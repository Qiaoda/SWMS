...
import cn.jitmarketing.hot.ui.shelf.InStockDiffActivity;
import cn.jitmarketing.hot.ui.shelf.InStockListActivity;
import cn.jitmarketing.hot.ui.shelf.L4ShelfAndInStockActivity;
...
import cn.jitmarketing.hot.ui.shelf.SignActivity;
...
import cn.jitmarketing.hot.ui.sku.OtherShopStockActivity;
...
public class HotApplication extends ExApplication {
	...
	public void onCreate() {
		...
		soundMap.put(4, soundPool.load(getApplicationContext(), R.raw.warning, 1));
		// 错误日志捕获
	...
	private void initMenuConfig() {
		...
		// 其他门店查询
		MenuConfigBean beanQTMDCX = new MenuConfigBean();
		beanQTMDCX.setBgDrawableID(R.drawable.main_search_click_button);
		beanQTMDCX.setIconDrawableID(R.drawable.othershop);
		beanQTMDCX.setActivityClass(OtherShopStockActivity.class);
		configMap.put("QTMDCX", beanQTMDCX);
		// 待复位
		...
		// 入库签收
		MenuConfigBean rkqs = new MenuConfigBean();
		rkqs.setBgDrawableID(R.drawable.main_outstore_click_button);
		rkqs.setIconDrawableID(R.drawable.sign);
		rkqs.setActivityClass(SignActivity.class);
		configMap.put("RKQS", rkqs);
		//入库差异
		MenuConfigBean rkcy = new MenuConfigBean();
		rkcy.setBgDrawableID(R.drawable.main_outstore_click_button);
		rkcy.setIconDrawableID(R.drawable.diff);
		rkcy.setActivityClass(InStockDiffActivity.class);
		configMap.put("RKCY", rkcy);
		
		// 绿4管理
		MenuConfigBean lsgl = new MenuConfigBean();
		lsgl.setBgDrawableID(R.drawable.main_outstore_click_button);
		lsgl.setIconDrawableID(R.drawable.l4manager);
		lsgl.setActivityClass(L4ShelfAndInStockActivity.class);
		configMap.put("LSGL", lsgl);

		// 抽盘
		MenuConfigBean chpan = new MenuConfigBean();
		chpan.setBgDrawableID(R.drawable.main_outstore_click_button);
		chpan.setIconDrawableID(R.drawable.choup);
		chpan.setActivityClass(ChouPanActivity.class);
		configMap.put("CP", chpan);
		// 添加库位
