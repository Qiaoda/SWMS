...
public class SkuNet {
    ...
    public static HashMap<String, String> getNew(String skuCode, String recordid) {
        HashMap<String, String> map = new HashMap<String, String>();
        map.put("UserID", HotApplication.getInstance().getUserId());
        map.put("UnitID", HotApplication.getInstance().getUnitId());
        map.put("SKUCode", skuCode.toUpperCase().trim());
     ...
     * 出样提醒列表
     */
    public static HashMap<String, String> getRemindSampleList(String SKUCode, int pageIndex, int pageSize, int bigType) {
        HashMap<String, String> map = new HashMap<String, String>();
        map.put("UnitID", HotApplication.getInstance().getUnitId());
        map.put("UserID", HotApplication.getInstance().getUserId());
        map.put("PageIndex", pageIndex + "");
