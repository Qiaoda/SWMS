...
public class WarehouseNet {
    ...
    public static HashMap<String, String> getShelfHistoryDetail(String ShelfLocationCode, String
            CheckTaskID, String PageIndex, String PageSize, String mAscode) {
        HashMap<String, String> map = new HashMap<String, String>();
        map.put("UserID", HotApplication.getInstance().getUserId());
        map.put("UnitID", HotApplication.getInstance().getUnitId());
        map.put("PageIndex", PageIndex);
    ...
    ///调拨通知单列表查询(执行调拨操作)
    public static HashMap<String,String> allocationNoticeParams(String unitID,String allocationBatchNo,int PageIndex,int PageSize){
    	 HashMap<String, String> map = new HashMap<String, String>();
         map.put("UserID", HotApplication.getInstance().getUserId());
         map.put("UnitID", HotApplication.getInstance().getUnitId());
         map.put("allocationBatchNo", allocationBatchNo);
         map.put("PageIndex", "0");
         map.put("PageSize", "20");
         return map;
    }
