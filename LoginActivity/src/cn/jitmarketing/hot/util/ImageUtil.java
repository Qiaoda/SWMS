...
//		String result = Base64.encodeToString(byteServer.Base64.DEFAULT);
	 ...
	 * @param view
	 */
	public static void uploadImage(Context context, String url, ImageView imageView, Callback callback) {
		//如果加载发生错误会重复三次请求，三次都失败才会显示erro Place holder
		Picasso.with(context)
		.load(url)
		.error(R.drawable.icon)
	 ...
	 * @param view
	 */
	public static void uploadImageCache(Context context, String url, ImageView imageView, Callback callback) {
		//如果加载发生错误会重复三次请求，三次都失败才会显示erro Place holder
