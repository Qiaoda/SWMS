 ...
 *
 */
public class L4ShelfAndStockDetailActivity extends BaseSwipeBackAcvitiy implements
        OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.lv_left:
                ...
                Intent intent1 = new Intent(L4ShelfAndStockDetailActivity.this,
                        L4MainShelfAndActivity.class);
            ...
            case R.id.lv_right://添加
                ...
                intent.setClass(L4ShelfAndStockDetailActivity.this,
                        L4HandShelfActivity.class);
