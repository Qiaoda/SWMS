...
public class HandShelfActivity extends BaseSwipeOperationActivity implements
	...
	public void onClick(View v) {
		...
		case R.id.hand_shelf_sure:
			...
			if(null == hand_shelf_location.getText(this) || 
				null == hand_shelf_count.getText().toString() || 
				null ==hand_shelf_sku.getText().toString()){
				Ex.Toast(mActivity).show("输入框内容不要为空");
				return;
			}

			if(!hand_shelf_location.getText(this).startsWith("E")){
