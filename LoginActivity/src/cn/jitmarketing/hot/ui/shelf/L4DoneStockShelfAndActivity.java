 ...
 * 用于入库完成以后的信息修改
 */
public class L4DoneStockShelfAndActivity extends BaseSwipeOperationActivity implements OnClickListener{
	...
	public void onSuccess(int what, String result, boolean hashCache) {
		...
		case WHAT_NET_INFO:
			...
			if(rb != null && rb.checkinstockdetailList.size() > 0){
				...
				for (InStockDetail dd : rb.checkinstockdetailList) {
					if (dd.ShelfLocationCode.equals(sku_shelf.getText(L4DoneStockShelfAndActivity.this))) {
						ddList.add(dd);
					}
				}
				// 获取暂存数据
