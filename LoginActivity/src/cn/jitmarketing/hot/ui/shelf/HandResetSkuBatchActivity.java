...
public class HandResetSkuBatchActivity extends BaseSwipeOperationActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.hand_sku_sure:
		     ...
		     if(shelfCode.equals("") || stringcount.equals("")){
			     ...
			     Intent intent = new Intent(this, ResetSkuBatchActivity.class);
