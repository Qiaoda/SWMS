...
import cn.jitmarketing.hot.adapter.InStockSignListAdapter;
 ...
 * 入库签收
 */
public class InStockSignActivity extends BaseSwipeOperationActivity implements OnClickListener, OnItemClickListener {
	...
	private InStockSignListAdapter instockSignListAdapter;
	...
	protected int exInitLayout() {
		return R.layout.activity_instock_sign;
	}
	@Override
	...
	protected void exInitView() {
		...
		shelf_and_stock.setText("入库签收");
		shelf_and_stock.setOnLeftClickListner(this);
		shelf_and_stock.setOnRightClickListner(this);
		instockSignListAdapter = new InStockSignListAdapter(this, getLayoutInflater(), receList);
		initListViewFooter();
		and_list.setAdapter(instockSignListAdapter);
	...
	public void onSuccess(int what, String result, boolean hashCache) {
		...
		case WHAT_NET_GET_IN_STOCK_LIST:
			...
			try {
				...
				receList.addAll(sheetList);
				instockSignListAdapter.notifyDataSetChanged();
			} catch (JSONException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public void fillCode(String code) {
		if (canReceive) {
			...
			Intent intent = new Intent(InStockSignActivity.this, SignActivity.class);
