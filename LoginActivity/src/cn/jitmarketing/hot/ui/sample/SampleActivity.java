...
public class SampleActivity extends BaseSwipeBackAcvitiy implements View.OnClickListener {
    ...
    protected void exInitView() {
        ...
        //findViewById(R.id.btn_supply_amount_remind).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_chouytx:
                ...
                break;
           // case R.id.btn_supply_amount_remind:
            	//Ex.Activity(mActivity).start(SupplyAmountRemindActivity.class, null);
            	//break;
            default:
                break;
        }
