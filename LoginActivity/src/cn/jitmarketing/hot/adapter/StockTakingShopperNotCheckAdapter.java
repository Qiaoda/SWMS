				...
				.setPositiveButton(R.string.sureTitle,
					...
					public void onClick(DialogInterface dialog,
						...
						if(entity.ShelfLocationCode.equals("EX00001"))
							...
							((StockTakingShopperDetailListActivity)activity).openOc("OC00001", true);
						else if(entity.ShelfLocationCode.equals("OW00001"))
							((StockTakingShopperDetailListActivity)activity).openOc("OW00001", true);
					}
				})
				...
				.setPositiveButton(R.string.sureTitle,
					...
					public void onClick(DialogInterface dialog,
						...
						if(entity.ShelfLocationCode.equals("EX00001")){
							...
							((StockTakingShopperDetailListActivity)activity).finishOcTask("OC00001");
						}else if(entity.ShelfLocationCode.equals("OW00001")){
							((StockTakingShopperDetailListActivity)activity).finishOcTask("OW00001");
						}
					}
				})
				.setNegativeButton(R.string.cancelTitle,
