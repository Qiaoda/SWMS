...
public class StockTakingShopperCompleteAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.xsp_layout = (LinearLayout)convertView.findViewById(R.id.xsp_layout);
			holder.xsp_diff_price = (TextView)convertView.findViewById(R.id.xsp_diff_price);
			holder.xsp_diff_count = (TextView)convertView.findViewById(R.id.xsp_diff_count);
			holder.xsp_sys_count = (TextView)convertView.findViewById(R.id.xsp_sys_count);
		...
		//盲盘逻辑
		if(entity.ShelfLocationCode.equals("SC00001")){
			holder.money_txt.setText(entity.PriceCount);
		}else{
			holder.money_txt.setText("***");
		}
		//holder.money_txt.setText(entity.PriceCount);
...
//			holder.xsp_layout.setVisibility(View.VISIBLE);
//			holder.xsp_diff_price.setText(String.valueOf(entity.SmallGoodPriceCount));
//			holder.xsp_diff_count.setText(String.valueOf(entity.SmallGoodDiffCount));
//			holder.xsp_sys_count.setText(String.valueOf(entity.SmallGoodSysStock));
//		}
		//已确认开启小商品盘点
		if(entity.ShelfLocationCode.equals("EX00001") || entity.ShelfLocationCode.equals("SC00001") ||
				 entity.ShelfLocationCode.equals("OC00001") || entity.ShelfLocationCode.equals("OW00001")) {
			...
			public void onClick(View v) {
				...
				.setPositiveButton(R.string.sureTitle,
					...
					public void onClick(DialogInterface dialog,
						...
						else if(entity.ShelfLocationCode.equals("OC00001"))
							((StockTakingShopperDetailListActivity)activity).openOc("OC00001", false);
						else if(entity.ShelfLocationCode.equals("OW00001"))
							((StockTakingShopperDetailListActivity)activity).openOc("OW00001", false);
					}
				})
		...
		convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				//盲盘逻辑
				if(!entity.ShelfLocationCode.equals("SC00001") && !entity.ShelfLocationCode.equals("EX00001"))
					return;
	...
	class ViewHolder {
		...
		LinearLayout xsp_layout;
		TextView xsp_diff_price;
		TextView xsp_sys_count;
		TextView xsp_diff_count;
	}
