...
public class StockTakingDetailAdapter extends BaseAdapter {
	...
	public StockTakingDetailAdapter(Activity activity, List<StockTakingDetailEntity> stockList, boolean isHistory) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(entity.IsSmallGoods || isHistory){
			...
			holder.dif_txt.setText("***");
			holder.sys_txt.setText("***");
			holder.actual_txt.setText("***");
			holder.dif_count_txt.setText("***");
		}
