...
public class HotConstants {
	...
	public static class Global {
		...
		/**其他门店查询*/
		public static String OTHER_SHOP_STOCK = "SKUManager/OtherStoreStockQuery";
		/**入库签收*/
		public static String IN_STOCK_SIGN = "Bill/GetDeliverReceivesheetList";
		/**入库签收确认*/
		public static String IN_STOCK_SIGN_CONFIRM = "Bill/ConfirmReceivesheet";
		/**入库差异*/
		public static String IN_STOCK_DIFF = "Bill/GetDifferenceOrderList";
		/**入库差异确认*/
		public static String IN_STOCK_DIFF_CONFIRM = "ChangeStock/SaveChangeStocksDiff";
		/**入库差异单查找*/
		public static String IN_STOCK_DIFF_QUERY = "Bill/GetDifferenceOrderNo";
		
		/**上传设备信息*/
		public static String UPLOAD_DEVICE_INFO = "System/GetDeviceInfo";
		
		/**E3库存查询*/
		public static String E3_STOCK_QUERY_INFO = "http://wx.hotwind.net/miniprog/item/loadItemInfoWithStock.do";
		//public static String E3_STOCK_QUERY_INFO = "http://10.0.17.19:8780/miniprog/item/loadItemInfoWithStock.do";
		/**获取小程序token*/
		public static String WECHAT_TOKEN = "http://wx.hotwind.net/hwcrmweb/wechat/getProgramToken.do";
		/**生成小程序码*/
		public static String WECHAT_GENERATE_IMAGE = "https://api.weixin.qq.com/wxa/getwxacodeunlimit?access_token=";
		
		/**机构获取二维码*/
		public static String ORG_QR_CODE_URL = "http://wxapp.hotwind.net/pda/qrcode/getQrCode/?accessToken=";
		
		/**机构获取日志*/
		public static String ORG_UPLOAD_URL = "http://wxapp.hotwind.net/pda/upload/uploadLog";
		
		public static String WECHAT_ALARM = "http://wxapp.hotwind.net/template/sendTemplate2workWechat.do";

		public static String LOG_UPLOAD_URL = "System/UploadLogFile";
		...
		public static final String SYS_PERMISSION = "extra.mdm.request";
		public static final String JIEBAO_HT380 = "HT380";
		public static final String UROVO_I6200S = "i6200S";
		public static final String UROVO_I6200A = "i6200A";//黑色手机型号
		public static final String GIONEELY72_KK = "gioneely72_cwet_kk";//黑色新款
		...
		/**上传错误日志url*/
		public static final String UPLOAD_ERROR_URL = "AppInfo/SaveCrashExcpLog";
		public static String servreDownloadUrl = null;// 服务器下载地址

		// 是否启用小商品版本
		public static boolean isStartXSPVersion = true;
		  /*SKU码*/
	...
	public static class SKU {
		...
		public static final String GetSkuPromotionPriceInfo = "SKU/GetSkuPromotionPriceInfo"; //促销活动
		/**
		 * 模糊查询商品
		 */
		...
		/**补量提醒*/
		public static final String 	GET_SUPPLY_SAMPLE_REMIND = "SKU/GetSampleSupplementRemindList";
		/**生成补量通知*/
		public static final String 	ADD_SUPPLY_REMIND_NOTICE = "SKU/SampleSupplementOperate";
		/**
		 * 直接出样（非鞋类）
		 **/
	...
	public static class Shelf {
		...
		public static final String ALLOCATION_NOTICE = "AllocationOrder/GetAllocationNoticeList";
		/**
		 * 挑拨记录
		 */
		...
		/**绿4订单*/
		public static final String L4_STOCKINLIST = "StorageInAndShelves/ReceiveGreenLists";
		/**更新绿4订单明细接口*/
		public static final String L4_UPDATE_DETAIL = "StorageInAndShelves/UpdateGreenSKUStockShelves";
		/**绿4订单入库单查找*/
		public static final String L4_STOCKINSEARCH = "StorageInAndShelves/GreenFourReceiveHistoryLists";
	...
	public static class RandomCheck{
		...
		/*判断抽盘任务是否开启*/
		public static final String CHOUPAN_TASK_ENABLED = "NewCheck/GetSmokeCheckTask";
		/*获取所有待抽盘的sku*/
		public static final String CHOUPAN_ALL_SKU = "NewCheck/GetSmokeSkuList";
		/*抽盘提交*/
		public static final String CHOUPAN_CONFIRM = "NewCheck/SubmitSmokeCheckSkuShelfLocationList";
	}
	/**单库位*/
